...
Installing "Divi Image Overlay" can be done either by searching for "Divi Image Overlay" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
